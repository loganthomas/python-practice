...
@pytest.mark.parametrize(
    'wire_points, expected',
    wire_metapoints_test_data,
    ids=[
        'only_x_vals',
        'only_y_vals',
        'provided_example_1_wire1',
        'provided_example_1_wire2',
        'provided_example_2_wire1',
        'provided_example_2_wire2',
        'provided_example_3_wire1',
...
intersection_test_data = [
    ...
    (['R5', 'U5', 'L5'], ['U5'], [day3.Point(0, 5)]),
    (['U5', 'R5'], ['R5', 'U5'], [day3.Point(5, 5)]),
    (['R8', 'U5', 'L5', 'D3'], ['U7', 'R6', 'D4', 'L4'], [day3.Point(3, 3), day3.Point(6, 5)]),
    (
        ['R75', 'D30', 'R83', 'U83', 'L12', 'D49', 'R71', 'U7', 'L72'],
        ['U62', 'R66', 'U55', 'R34', 'D71', 'R55', 'D58', 'R83'],
...
@pytest.mark.parametrize(
    'wire1_instr, wire2_instr, expected',
    intersection_test_data,
    ids=[
        'simple_inter_(0,5)',
        'simple_inter_(5,5)',
...
closest_point_test_data = [
    ...
    ([day3.Point(0, 5)], (day3.Point(0, 5), 5)),
    ([day3.Point(5, 5)], (day3.Point(5, 5), 10)),
    ([day3.Point(0, 5), day3.Point(5, 5)], (day3.Point(0, 5), 5)),
    ([day3.Point(3, 3), day3.Point(6, 5)], (day3.Point(3, 3), 6)),
    (
        [day3.Point(158, -12), day3.Point(146, 46), day3.Point(155, 4), day3.Point(155, 11)],
