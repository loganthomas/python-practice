...
def test_sum_even_odd_slicing(n: int, expected_even_sum: int, expected_odd_sum: int) -> None:
...
def test_sum_even_odd_mod(n: int, expected_even_sum: int, expected_odd_sum: int) -> None:
    # Setup - none necessary
